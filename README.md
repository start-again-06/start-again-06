...
Anjan Mahapatra is a tech-savvy, analytical builder with a strong engineering foundation and a growing expertise across AI/ML, product management, strategy, growth, and financial decision-making. He has worked across manufacturing, construction, and SaaS, contributing to end-to-end product journeys spanning problem discovery, market research, product strategy, system architecture, user workflows, data-driven analysis, growth planning, financial evaluation, and go-to-market execution. He brings together technical depth, product thinking, business strategy, and financial acumen to build solutions that are not only innovative, but also scalable, commercially viable, and outcome-driven.

With a multidisciplinary engineering and computational background, Anjan focuses on emerging AI paradigms including LLMs, SLMs, AGI, physical AI, and agentic AI systems. He is particularly interested in designing intelligent and increasingly autonomous systems that bridge digital intelligence with real-world applications. His approach combines technical architecture with product vision, strategic thinking, usability, growth orientation, and financial awareness—enabling him to evaluate opportunities not only from a technology perspective, but also through the lens of customers, markets, economics, and long-term business impact.

His interest in finance and investment decision-making is further supported by professional credentials including CAPM®, CFA® Level I, and CIPM® Level I, strengthening his understanding of project management, investment analysis, portfolio performance, and performance measurement. This combination of engineering, AI, product, strategy, and finance allows Anjan to operate at the intersection of technology, business, and capital allocation, with a focus on transforming complex ideas into practical, scalable, and high-impact products.
...
*Building own three venture-backed startups in high-growth markets (something I am fond of apart from the regular job)*:
  ...
  * *Arogyavani - Doctor Talks* — *Co-founder, Co-founder (Dr. Alisha Mahapatra)* — AI-powered multilingual voice platform automating customer engagement at scale *(Product Development Stage)*.
  * *Humrahi* — *Co-founder, Co-founder (Vedant Gugale)* — AI-powered multilingual voice platform providing personalized assistance and support for elderly people *(Product Development Stage)* - Are we going for YC - Definitely Yes - 2 November mark the date boi.
...
2. Droplet Dynamics and Control in Microfluidic Platform for Enhanced System Design,  
   Anjan Mahapatra*, Rithanya Raj.  
   *Frontiers in Lab on a Chip Technologies - Micro- and Nano-fluidics*, Frontiers. (Under Review)
